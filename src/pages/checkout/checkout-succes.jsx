...
export default function CheckoutSucces() {
  return (
    <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 py-4">
      <div className="container-fluid ">
        ...
        <div className="pt-70 pb-50" style={{ color: '#feda15' }}>
        ...
        <div className="button-group d-flex flex-column mx-auto">
          {/* <a href="/" className="btn btn-whatsapp fw-medium text-lg color-palette-1 rounded-pill " role="button">
            WhatsApp ke Admin
          </a> */}
        </div>
      </div>
